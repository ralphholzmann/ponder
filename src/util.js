...
module.exports.transforms = new Map([
  ...
  [GROUPED_STREAM_TYPE, new Map([
    ['ungroup', ARRAY_TYPE]
  ])],
  [GROUPED_DATA_TYPE, new Map([
    ['ungroup', ARRAY_TYPE]
  ])],
  [OBJECT_TYPE, new Map([
    ['count', NUMBER_TYPE],
  ...
  [BOOLEAN_TYPE, new Map([
    ['and', BOOLEAN_TYPE],
    ['or', BOOLEAN_TYPE],
    ['not', BOOLEAN_TYPE],
  ])],
  [GEOMETRY_TYPE, new Map([
    ['distance', NUMBER_TYPE],
  ...
  [POLYGON_TYPE, new Map([
    ['polygon', POLYGON_TYPE],
    ['polygonSub', POLYGON_TYPE],
  ])]
]);
